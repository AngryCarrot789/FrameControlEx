...
namespace FrameControlEx.Core.Views.Dialogs.FilePicking {
    public sealed class Filter {
        ...
        public Filter Add(string readableName, params string[] extensions) {
        ...
        public Filter Add(string readableName, string extension) {
            if (string.IsNullOrWhiteSpace(readableName)) {
                throw new ArgumentException("Readable name cannot be null, empty, or consist of only whitespaces", nameof(readableName));
            }
